<template>
  <div class="container">
    ...
    <el-table :data="tableData" v-loading="loading" style="width: 100%" >
      <el-table-column align="center" prop="trlocation" label="景区" width="300"></el-table-column>

      <el-table-column align="center" prop="trcontent" label="攻略内容" width="280">
      ...
      <el-table-column align="center" label="建议携带" width="440">
        <template slot-scope="scope">
          {{scope.row.trproducts.join('、')}}
        </template>
      </el-table-column>
      <el-table-column align="center" prop="trbudget" label="预算" width="120"></el-table-column>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      doAddScenic(){
        this.$router.push('/guide/editStrategy');
      },
      doEditScenic(item){
        this.$router.push({path:'/guide/editStrategy',query:{id:item.trid}})
      },
      doRemoveScenic(item){
        let that = this;
