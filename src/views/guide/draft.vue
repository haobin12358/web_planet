<template>
  <div class="container">
    ...
    <el-table :data="tableData" v-loading="loading" style="width: 100%" >
      ...
      <el-table-column align="center" prop="sspname" label="起止时间" width="280"></el-table-column>
      <el-table-column align="center" prop="ssparea" label="地点" width="280"></el-table-column>
      <el-table-column align="center" prop="ssplevel" label="最大承载人数" width="280">
        <template slot-scope="scope">
      ...
      <el-table-column align="center" prop="parent_scenicspot.sspname" label="活动保险" width="280"></el-table-column>
      <el-table-column align="center" prop="ssplevel" label="报名填写项" width="280">
        <template slot-scope="scope">
          <span>{{scope.row.ssplevel}}A</span>
        </template>
      </el-table-column>
      <el-table-column align="center" label="建议携带" >
        <template slot-scope="scope">
          <el-switch v-model="scope.row.associated" disabled active-color="#409EFF"
                     inactive-color="#DBDCDC">
          </el-switch>
...
<!--      <el-table-column align="center" prop="parent_scenicspot.sspname" label="推文" width="280"></el-table-column>-->
