  ...
  <div class="container">
    ...
    <el-table :data="tableData" v-loading="loading" :cell-class-name="cellFunction">
      <el-table-column label="审批内容" align="center">
        <el-table-column align="center" width="220" label="图片">
          <template slot-scope="scope">
            <table-cell-img :src="[scope.row.content.toimage]" :key="scope.row.avid"></table-cell-img>
          </template>
        </el-table-column>
        <el-table-column label="经度" prop="content.longitude" align="center" width="120"></el-table-column>
        <el-table-column label="纬度" prop="content.latitude" align="center" width="120"></el-table-column>
