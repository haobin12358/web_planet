  ...
  <div class="container">
    ...
    <el-table :data="tableData" v-loading="loading">
      <el-table-column label="审批内容" align="center">
        ...
        <el-table-column align="center" prop="content.tlaname" label="活动名称" width="180">
        </el-table-column>
        <el-table-column align="center" prop="content.tlpstock" label="参与数量" width="120"></el-table-column>
