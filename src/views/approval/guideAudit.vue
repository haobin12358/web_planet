  ...
  <div class="container">
    ...
    <el-table :data="tableData" v-loading="loading" :cell-class-name="cellFunction">
      <el-table-column label="审批内容" align="center">
        <el-table-column label="真实姓名" prop="content.gurealname" align="center" width="120"></el-table-column>
        <el-table-column label="手机号" prop="content.gutelphone" align="center" width="120"></el-table-column>
        <el-table-column label="身份证号" prop="content.guidentification" align="center" width="120"></el-table-column>
        <el-table-column align="center" width="220" label="导游证明">
          <template slot-scope="scope">
            <table-cell-img :src="[scope.row.content.guimg]" :key="scope.row.avid"></table-cell-img>
          </template>
        </el-table-column>
